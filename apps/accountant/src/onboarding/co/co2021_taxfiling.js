...
const config = {
  default: {
    iconsPath: 'images/icons/onboarding/2021/',
    lastTab: '0.0',
    personalInfoTab: '1.',
    dianTab: '1.',
    currentTab: '1.',
    ...
    navObject: [
      {
        ...
        sectionSubtitle:
          'El primer paso para elaborar la declaración de renta de tu cliente es conectar la cuenta de la DIAN para personalizar la experiencia según tu historial tributario. La conexión es completamente segura y automática, no tienes de qué preocuparte.',
      ...
      },
      {
        ...
        sectionTitle: 'Bienes',
        sectionSubtitle:
          'Selecciona los bienes que tenías al 31 de diciembre 2021',
      ...
      },
      {
        ...
        sectionSubtitle:
          'Selecciona los tipos de ingresos que tuviste durante el 2021',
      ...
      },
      {
        ...
        sectionSubtitle: 'Selecciona los productos que tuviste durante el 2021',
